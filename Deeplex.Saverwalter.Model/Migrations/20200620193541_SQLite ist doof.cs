...
{
    public partial class SQLiteistdoof : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    JuristischePersonAnhangId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    AnhangId = table.Column<Guid>(type: "TEXT", nullable: false),
                    PersonJuristischePersonId = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NatuerlichePersonAnhangId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    AnhangId = table.Column<Guid>(type: "TEXT", nullable: false),
                    PersonNatuerlichePersonId = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Vertragrowid = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
