...
namespace Deeplex.Saverwalter.Model.Migrations.Npgsql
{
    ...
    [Migration("20231118212401_AddTablesUmlagetypenAndHKVO")]
    partial class AddTablesUmlagetypenAndHKVO
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Deeplex.Saverwalter.Model.HKVO", b =>
                {
                    ...
                    b.Property<int>("BetriebsstromId")
                        .HasColumnType("integer")
                        .HasColumnName("betriebsstrom_id");
                    ...
                    b.HasIndex("BetriebsstromId")
                        .IsUnique()
                        .HasDatabaseName("ix_hkvo_betriebsstrom_id");
            ...
            modelBuilder.Entity("Deeplex.Saverwalter.Model.HKVO", b =>
                {
                    b.HasOne("Deeplex.Saverwalter.Model.Umlage", "Betriebsstrom")
                        .WithOne("HKVO")
                        .HasForeignKey("Deeplex.Saverwalter.Model.HKVO", "BetriebsstromId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_hkvo_umlagen_betriebsstrom_id");
