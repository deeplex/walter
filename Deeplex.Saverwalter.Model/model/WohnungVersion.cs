...
{
    public class WohnungVersion
    {
        public int WohnungVersionId { get; set; }
        [Required]
        ...
        public WohnungVersion(DateOnly beginn, decimal wohnflaeche, decimal nutzflaeche, decimal miteigentumsanteile, int nutzeinheit)
        {
            Beginn = beginn;
