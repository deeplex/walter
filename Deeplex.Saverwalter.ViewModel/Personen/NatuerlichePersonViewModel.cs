...
namespace Deeplex.Saverwalter.ViewModels
{
    public sealed class NatuerlichePersonViewModel : PersonViewModel
    {
        ...
        public NatuerlichePersonViewModel(int id, IAppImplementation impl)
            : this(impl.ctx.NatuerlichePersonen.Find(id), impl) { }

        public NatuerlichePersonViewModel(IAppImplementation impl) : this(new NatuerlichePerson(), impl) { }
        public NatuerlichePersonViewModel(NatuerlichePerson k, IAppImplementation impl)
        {
            Impl = impl;
